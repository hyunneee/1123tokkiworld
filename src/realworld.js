...
const backgroundImage = textureLoader.load('../public/sky.jpg');
...
controls.maxPolarAngle = Math.PI/1.2;
  ...
  loader.load('../public/src/low_poly_city.glb', (gltf) => {
...
// GLB 파일 로드
loader.load('../public/src/cafe_soca.glb', (gltf) => {
  scene.add(gltf.scene);
...
function createAnimatedPointer(x, y, z) {
  // Load pointer model
  loader.load('../public/src/map_pointer.glb', (gltf) => {
...
loader.load('../public/src/glb_npc/standing_npc.glb', (gltf) => {
  npc = gltf.scene;
...
loader.load('../public/src/glb_npc/sitting_npc.glb', (gltf) => {
  npc2 = gltf.scene;
...
loader.load('../public/src/glb_purple/talking.glb', (gltf) => {
...
loader.load('../public/src/glb_yellow/komin.glb', (gltf) => {

...
const backgroundImage = textureLoader.load('../public/back.png');
...
phone.load('../public/src/phone.glb', function (gltf) {
...
let vrModel;
vr.load('../public/src/hmd.glb', function (gltf) {
...
table.load('../public/src/table.glb', function (gltf) {
...
chair.load('../public/src/chair2.glb', function (gltf) {
...
let arrowModel; // 배달
arrow.load('../public/src/mouse_arrow.glb', function (gltf) {
...
wifi.load('../public/src/wifi.fbx', (fbx) => {
  wifiModel = fbx;
...
let callModel;
call.load('../public/src/call.fbx', (fbx) => {
  callModel = fbx;
...
let msgModel;
msg.load('../public/src/msg2.fbx', (fbx) => {
  msgModel = fbx;
  // Adjust the position, rotation, and scale of the loaded model as needed
...
let messageModel;
message.load('../public/src/message.fbx', (fbx) => {
  messageModel = fbx;
  // Adjust the position, rotation, and scale of the loaded model as needed
...
airplane.load('../public/src/plane.fbx', (fbx) => {
  airplaneModel = fbx;
  // Adjust the position, rotation, and scale of the loaded model as needed
...
folder.load('../public/src/folder.fbx', (fbx) => {
  folderModel = fbx;
  // Adjust the position, rotation, and scale of the loaded model as needed
...
const models = {
  pink: '../public/src/glb_pink/',
  yellow: '../public/src/glb_yellow/',
  green: '../public/src/glb_green/',
  blue: '../public/src/glb_blue/',
  purple: '../public/src/glb_purple/',
  default: '../public/src/glb_pink/'
};

...
// GLB 파일 로드
loader.load('../public/src/cafe.glb', (gltf) => {
...
loader.load('../public/src/laptop.glb', (gltf) => {
...
loader.load('../public/src/coffee_cup.glb', (gltf) => {
...
loader.load('../public/src/glb_npc/eating_npc.glb', (gltf) => {
